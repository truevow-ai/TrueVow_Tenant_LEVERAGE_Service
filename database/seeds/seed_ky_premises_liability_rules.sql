...
-- Primary Authority: KRS § 381.232; Carter v. Kinney, 896 S.W.2d 926 (Mo. 1995)
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Kentucky Premises Liability - Traditional Three-Tier Premises Liability',
    'Kentucky Courts',
    'KRS § 381.232; Carter v. Kinney, 896 S.W.2d 926 (M',
    '',
    'case_law',
    'high',
    'Kentucky follows the Traditional Three-Tier Premises Liability for premises liability cases. Authority: KRS § 381.232; Carter v. Kinney, 896 S.W.2d 926 (Mo. 1995). NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'KY-PREM-LIAB-TRAD-3-TIER',
    5,
    'KY Premises Liability Traditional Three-Tier Premises Liability',
    'content_check',
    'personal_injury',
    'premises_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "KRS § 381.232; Carter v. Kinney, 896 S.W.2d 926 (Mo. 1995)",
...
-- =====================================================================================
-- END OF KENTUCKY PREMISES LIABILITY SEED FILE
-- =====================================================================================
