...
-- Primary Authority: N.J.S.A. § 2A:15-5.1
-- 
...
-- Source: New Jersey Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'New Jersey Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'New Jersey Legislature',
    'N.J.S.A. § 2A:15-5.1',
    '',
    'statute',
    'high',
    'New Jersey follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: N.J.S.A. § 2A:15-5.1. NEEDS REVIEW.'
...
-- Rule: New Jersey Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'NJ-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'NJ Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF NEW JERSEY CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
