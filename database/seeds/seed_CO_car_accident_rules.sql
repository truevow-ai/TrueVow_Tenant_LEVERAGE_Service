...
-- Primary Authority: C.R.S. § 13-21-111
-- 
...
-- Source: Colorado Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Colorado Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Colorado Legislature',
    'C.R.S. § 13-21-111',
    '',
    'statute',
    'high',
    'Colorado follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: C.R.S. § 13-21-111. NEEDS REVIEW.'
...
-- Rule: Colorado Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'CO-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'CO Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF COLORADO CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
