...
-- Primary Authority: Tenn. Code Ann. § 20-1-119
-- 
...
-- Source: Tennessee Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Tennessee Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Tennessee Legislature',
    'Tenn. Code Ann. § 20-1-119',
    '',
    'statute',
    'high',
    'Tennessee follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: Tenn. Code Ann. § 20-1-119. NEEDS REVIEW.'
...
-- Rule: Tennessee Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'TN-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'TN Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
    ...
    '{
        ...
        "statute": "Tenn. Code Ann. § 20-1-119",
...
-- =====================================================================================
-- END OF TENNESSEE CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
