...
-- Primary Authority: 735 ILCS 5/2-1116
-- 
...
-- Source: Illinois Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Illinois Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Illinois Legislature',
    '735 ILCS 5/2-1116',
    '',
    'statute',
    'high',
    'Illinois follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: 735 ILCS 5/2-1116. NEEDS REVIEW.'
...
-- Rule: Illinois Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'IL-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'IL Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF ILLINOIS CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
