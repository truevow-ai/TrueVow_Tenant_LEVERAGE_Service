...
-- Primary Authority: KRS § 411.300; Brandenburg v. Toyota Motor Sales, U.S.A.
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Kentucky Product Liability - Strict Liability (Restatement 402A)',
    'Kentucky Courts',
    'KRS § 411.300; Brandenburg v. Toyota Motor Sales, ',
    '',
    'case_law',
    'high',
    'Kentucky follows the Strict Liability (Restatement 402A) for product liability cases. Authority: KRS § 411.300; Brandenburg v. Toyota Motor Sales, U.S.A.. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'KY-PROD-LIAB-STRICT-402A',
    5,
    'KY Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "KRS § 411.300; Brandenburg v. Toyota Motor Sales, U.S.A.",
...
-- =====================================================================================
-- END OF KENTUCKY PRODUCT LIABILITY SEED FILE
-- =====================================================================================
