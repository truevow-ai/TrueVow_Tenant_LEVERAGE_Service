...
-- Primary Authority: MCL § 600.2959
-- 
...
-- Source: Michigan Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Michigan Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Michigan Legislature',
    'MCL § 600.2959',
    '',
    'statute',
    'high',
    'Michigan follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: MCL § 600.2959. NEEDS REVIEW.'
...
-- Rule: Michigan Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'MI-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'MI Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF MICHIGAN CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
