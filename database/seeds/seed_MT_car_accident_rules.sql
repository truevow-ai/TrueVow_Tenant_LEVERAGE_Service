...
-- Primary Authority: MCA § 27-1-702
-- 
...
-- Source: Montana Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Montana Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Montana Legislature',
    'MCA § 27-1-702',
    '',
    'statute',
    'high',
    'Montana follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: MCA § 27-1-702. NEEDS REVIEW.'
...
-- Rule: Montana Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'MT-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'MT Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF MONTANA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
