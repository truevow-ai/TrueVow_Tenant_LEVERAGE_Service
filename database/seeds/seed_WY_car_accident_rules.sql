...
-- Primary Authority: Wyo. Stat. Ann. § 1-1-109
-- 
...
-- Source: Wyoming Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Wyoming Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Wyoming Legislature',
    'Wyo. Stat. Ann. § 1-1-109',
    '',
    'statute',
    'high',
    'Wyoming follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: Wyo. Stat. Ann. § 1-1-109. NEEDS REVIEW.'
...
-- Rule: Wyoming Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'WY-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'WY Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF WYOMING CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
