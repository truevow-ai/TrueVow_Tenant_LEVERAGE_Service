...
-- Primary Authority: NRS § 41.515; Moody v. Manny''s Auto Repair
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Nevada Premises Liability - Traditional Three-Tier Premises Liability',
    'Nevada Courts',
    'NRS § 41.515; Moody v. Manny''s Auto Repair',
    '',
    'case_law',
    'high',
    'Nevada follows the Traditional Three-Tier Premises Liability for premises liability cases. Authority: NRS § 41.515; Moody v. Manny''s Auto Repair. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'NV-PREM-LIAB-TRAD-3-TIER',
    5,
    'NV Premises Liability Traditional Three-Tier Premises Liability',
    'content_check',
    'personal_injury',
    'premises_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "NRS § 41.515; Moody v. Manny''s Auto Repair",
...
-- =====================================================================================
-- END OF NEVADA PREMISES LIABILITY SEED FILE
-- =====================================================================================
