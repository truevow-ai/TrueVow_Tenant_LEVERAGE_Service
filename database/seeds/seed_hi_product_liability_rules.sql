...
-- Primary Authority: Hawaii common law; Yoshimoto v. Hawaiian Gas Products
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Hawaii Product Liability - Strict Liability (Restatement 402A)',
    'Hawaii Courts',
    'Hawaii common law; Yoshimoto v. Hawaiian Gas Produ',
    '',
    'case_law',
    'high',
    'Hawaii follows the Strict Liability (Restatement 402A) for product liability cases. Authority: Hawaii common law; Yoshimoto v. Hawaiian Gas Products. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'HI-PROD-LIAB-STRICT-402A',
    5,
    'HI Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "Hawaii common law; Yoshimoto v. Hawaiian Gas Products",
...
-- =====================================================================================
-- END OF HAWAII PRODUCT LIABILITY SEED FILE
-- =====================================================================================
