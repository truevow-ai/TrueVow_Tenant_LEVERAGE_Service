...
-- Primary Authority: S.C. Code Ann. § 15-73-10; Keeter v. Dennis Supply Co.
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'South Carolina Product Liability - Strict Liability (Restatement 402A)',
    'South Carolina Courts',
    'S.C. Code Ann. § 15-73-10; Keeter v. Dennis Supply',
    '',
    'case_law',
    'high',
    'South Carolina follows the Strict Liability (Restatement 402A) for product liability cases. Authority: S.C. Code Ann. § 15-73-10; Keeter v. Dennis Supply Co.. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'SC-PROD-LIAB-STRICT-402A',
    5,
    'SC Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "S.C. Code Ann. § 15-73-10; Keeter v. Dennis Supply Co.",
...
-- =====================================================================================
-- END OF SOUTH CAROLINA PRODUCT LIABILITY SEED FILE
-- =====================================================================================
