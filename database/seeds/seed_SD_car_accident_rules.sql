...
-- Source: South Dakota Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'South Dakota Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'South Dakota Legislature',
    'SDCL § 15-1-1',
    '',
    'statute',
    'high',
    'South Dakota follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: SDCL § 15-1-1. NEEDS REVIEW.'
...
-- Rule: South Dakota Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'SD-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'SD Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF SOUTH DAKOTA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
