...
-- Primary Authority: 42 Pa.C.S. § 7102
-- 
...
-- Source: Pennsylvania Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Pennsylvania Car Accident Negligence System - Modified Comparative Negligence (51% Bar Rule)',
    'Pennsylvania Legislature',
    '42 Pa.C.S. § 7102',
    '',
    'statute',
    'high',
    'Pennsylvania follows the Modified Comparative Negligence (51% Bar Rule) system for determining fault in car accident cases. Citation: 42 Pa.C.S. § 7102. NEEDS REVIEW.'
...
-- Rule: Pennsylvania Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'PA-PI-CAR-ACCDT-MOD-COMP-51',
    5,
    'PA Car Accident Modified Comparative Negligence (51% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF PENNSYLVANIA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
