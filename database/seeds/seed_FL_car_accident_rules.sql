...
-- Primary Authority: Fla. Stat. § 768.81
-- 
...
-- Source: Florida Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Florida Car Accident Negligence System - Pure Comparative Negligence',
    'Florida Legislature',
    'Fla. Stat. § 768.81',
    '',
    'statute',
    'high',
    'Florida follows the Pure Comparative Negligence system for determining fault in car accident cases. Citation: Fla. Stat. § 768.81. NEEDS REVIEW.'
...
-- Rule: Florida Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'FL-PI-CAR-ACCDT-PURE-COMP',
    5,
    'FL Car Accident Pure Comparative Negligence',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF FLORIDA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
