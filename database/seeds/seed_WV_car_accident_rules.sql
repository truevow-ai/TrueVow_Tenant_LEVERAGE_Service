...
-- Primary Authority: W. Va. Code § 55-7-13a
-- 
...
-- Source: West Virginia Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'West Virginia Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'West Virginia Legislature',
    'W. Va. Code § 55-7-13a',
    '',
    'statute',
    'high',
    'West Virginia follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: W. Va. Code § 55-7-13a. NEEDS REVIEW.'
...
-- Rule: West Virginia Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'WV-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'WV Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF WEST VIRGINIA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
