...
-- Primary Authority: N.C.G.S. § 99B-1; Raper v. McCrory-McLellan Corp.
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'North Carolina Product Liability - Strict Liability (Restatement 402A)',
    'North Carolina Courts',
    'N.C.G.S. § 99B-1; Raper v. McCrory-McLellan Corp.',
    '',
    'case_law',
    'high',
    'North Carolina follows the Strict Liability (Restatement 402A) for product liability cases. Authority: N.C.G.S. § 99B-1; Raper v. McCrory-McLellan Corp.. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'NC-PROD-LIAB-STRICT-402A',
    5,
    'NC Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "N.C.G.S. § 99B-1; Raper v. McCrory-McLellan Corp.",
...
-- =====================================================================================
-- END OF NORTH CAROLINA PRODUCT LIABILITY SEED FILE
-- =====================================================================================
