...
-- Source: Nevada Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Nevada Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Nevada Legislature',
    'NRS § 41.141',
    '',
    'statute',
    'high',
    'Nevada follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: NRS § 41.141. NEEDS REVIEW.'
...
-- Rule: Nevada Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'NV-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'NV Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF NEVADA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
