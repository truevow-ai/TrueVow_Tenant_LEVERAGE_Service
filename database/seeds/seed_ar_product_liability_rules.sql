...
-- Primary Authority: Ark. Code Ann. § 16-116-101; Rix v. Arkansas Kraft Corp.
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Arkansas Product Liability - Strict Liability (Restatement 402A)',
    'Arkansas Courts',
    'Ark. Code Ann. § 16-116-101; Rix v. Arkansas Kraft',
    '',
    'case_law',
    'high',
    'Arkansas follows the Strict Liability (Restatement 402A) for product liability cases. Authority: Ark. Code Ann. § 16-116-101; Rix v. Arkansas Kraft Corp.. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'AR-PROD-LIAB-STRICT-402A',
    5,
    'AR Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "Ark. Code Ann. § 16-116-101; Rix v. Arkansas Kraft Corp.",
...
-- =====================================================================================
-- END OF ARKANSAS PRODUCT LIABILITY SEED FILE
-- =====================================================================================
