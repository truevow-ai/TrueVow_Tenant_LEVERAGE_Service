...
-- Primary Authority: 12 Okl. St. § 13-2
-- 
...
-- Source: Oklahoma Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Oklahoma Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Oklahoma Legislature',
    '12 Okl. St. § 13-2',
    '',
    'statute',
    'high',
    'Oklahoma follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: 12 Okl. St. § 13-2. NEEDS REVIEW.'
...
-- Rule: Oklahoma Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'OK-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'OK Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF OKLAHOMA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
