...
-- Primary Authority: M.G.L. c. 231, § 85
-- 
...
-- Source: Massachusetts Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Massachusetts Car Accident Negligence System - Modified Comparative Negligence (51% Bar Rule)',
    'Massachusetts Legislature',
    'M.G.L. c. 231, § 85',
    '',
    'statute',
    'high',
    'Massachusetts follows the Modified Comparative Negligence (51% Bar Rule) system for determining fault in car accident cases. Citation: M.G.L. c. 231, § 85. NEEDS REVIEW.'
...
-- Rule: Massachusetts Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'MA-PI-CAR-ACCDT-MOD-COMP-51',
    5,
    'MA Car Accident Modified Comparative Negligence (51% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF MASSACHUSETTS CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
