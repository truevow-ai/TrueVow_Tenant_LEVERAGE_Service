...
-- Source: Hawaii Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Hawaii Car Accident Negligence System - Modified Comparative Negligence (51% Bar Rule)',
    'Hawaii Legislature',
    'HRS § 663-31',
    '',
    'statute',
    'high',
    'Hawaii follows the Modified Comparative Negligence (51% Bar Rule) system for determining fault in car accident cases. Citation: HRS § 663-31. NEEDS REVIEW.'
...
-- Rule: Hawaii Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'HI-PI-CAR-ACCDT-MOD-COMP-51',
    5,
    'HI Car Accident Modified Comparative Negligence (51% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF HAWAII CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
