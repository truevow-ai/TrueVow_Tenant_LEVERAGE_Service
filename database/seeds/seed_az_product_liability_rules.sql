...
-- Primary Authority: A.R.S. § 12-551; State Farm Fire & Casualty Co. v. Wynns
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Arizona Product Liability - Strict Liability (Restatement 402A)',
    'Arizona Courts',
    'A.R.S. § 12-551; State Farm Fire & Casualty Co. v.',
    '',
    'case_law',
    'high',
    'Arizona follows the Strict Liability (Restatement 402A) for product liability cases. Authority: A.R.S. § 12-551; State Farm Fire & Casualty Co. v. Wynns. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'AZ-PROD-LIAB-STRICT-402A',
    5,
    'AZ Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "A.R.S. § 12-551; State Farm Fire & Casualty Co. v. Wynns",
...
-- =====================================================================================
-- END OF ARIZONA PRODUCT LIABILITY SEED FILE
-- =====================================================================================
