...
-- Primary Authority: Antoniewicz v. Reszczynski, 70 Wis.2d 836 (1975)
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Wisconsin Premises Liability - Unified Reasonable Care Standard',
    'Wisconsin Courts',
    'Antoniewicz v. Reszczynski, 70 Wis.2d 836 (1975)',
    '',
    'case_law',
    'high',
    'Wisconsin follows the Unified Reasonable Care Standard for premises liability cases. Authority: Antoniewicz v. Reszczynski, 70 Wis.2d 836 (1975). NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'WI-PREM-LIAB-UNIFIED-CARE',
    5,
    'WI Premises Liability Unified Reasonable Care Standard',
    'content_check',
    'personal_injury',
    'premises_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "Antoniewicz v. Reszczynski, 70 Wis.2d 836 (1975)",
...
-- =====================================================================================
-- END OF WISCONSIN PREMISES LIABILITY SEED FILE
-- =====================================================================================
