...
-- Primary Authority: AS § 09.17.060
-- 
...
-- Source: Alaska Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Alaska Car Accident Negligence System - Pure Comparative Negligence',
    'Alaska Legislature',
    'AS § 09.17.060',
    '',
    'statute',
    'high',
    'Alaska follows the Pure Comparative Negligence system for determining fault in car accident cases. Citation: AS § 09.17.060. NEEDS REVIEW.'
...
-- Rule: Alaska Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'AK-PI-CAR-ACCDT-PURE-COMP',
    5,
    'AK Car Accident Pure Comparative Negligence',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF ALASKA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
