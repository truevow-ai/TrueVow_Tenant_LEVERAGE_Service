...
-- Primary Authority: RCW § 4.24.210; Tincani v. Inland Empire Zoological Society
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Washington Premises Liability - Traditional Three-Tier Premises Liability',
    'Washington Courts',
    'RCW § 4.24.210; Tincani v. Inland Empire Zoologica',
    '',
    'case_law',
    'high',
    'Washington follows the Traditional Three-Tier Premises Liability for premises liability cases. Authority: RCW § 4.24.210; Tincani v. Inland Empire Zoological Society. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'WA-PREM-LIAB-TRAD-3-TIER',
    5,
    'WA Premises Liability Traditional Three-Tier Premises Liability',
    'content_check',
    'personal_injury',
    'premises_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "RCW § 4.24.210; Tincani v. Inland Empire Zoological Society",
...
-- =====================================================================================
-- END OF WASHINGTON PREMISES LIABILITY SEED FILE
-- =====================================================================================
