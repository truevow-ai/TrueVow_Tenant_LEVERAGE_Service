...
-- Primary Authority: S.C. Code Ann. § 15-38-20
-- 
...
-- Source: South Carolina Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'South Carolina Car Accident Negligence System - Modified Comparative Negligence (51% Bar Rule)',
    'South Carolina Legislature',
    'S.C. Code Ann. § 15-38-20',
    '',
    'statute',
    'high',
    'South Carolina follows the Modified Comparative Negligence (51% Bar Rule) system for determining fault in car accident cases. Citation: S.C. Code Ann. § 15-38-20. NEEDS REVIEW.'
...
-- Rule: South Carolina Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'SC-PI-CAR-ACCDT-MOD-COMP-51',
    5,
    'SC Car Accident Modified Comparative Negligence (51% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF SOUTH CAROLINA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
