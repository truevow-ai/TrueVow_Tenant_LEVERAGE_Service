...
-- Primary Authority: 42 Pa.C.S. § 7102; Webb v. Zern
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Pennsylvania Product Liability - Strict Liability (Restatement 402A)',
    'Pennsylvania Courts',
    '42 Pa.C.S. § 7102; Webb v. Zern',
    '',
    'case_law',
    'high',
    'Pennsylvania follows the Strict Liability (Restatement 402A) for product liability cases. Authority: 42 Pa.C.S. § 7102; Webb v. Zern. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'PA-PROD-LIAB-STRICT-402A',
    5,
    'PA Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "42 Pa.C.S. § 7102; Webb v. Zern",
...
-- =====================================================================================
-- END OF PENNSYLVANIA PRODUCT LIABILITY SEED FILE
-- =====================================================================================
