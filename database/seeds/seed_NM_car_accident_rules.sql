...
-- Primary Authority: NMSA § 41-3A-1
-- 
...
-- Source: New Mexico Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'New Mexico Car Accident Negligence System - Pure Comparative Negligence',
    'New Mexico Legislature',
    'NMSA § 41-3A-1',
    '',
    'statute',
    'high',
    'New Mexico follows the Pure Comparative Negligence system for determining fault in car accident cases. Citation: NMSA § 41-3A-1. NEEDS REVIEW.'
...
-- Rule: New Mexico Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'NM-PI-CAR-ACCDT-PURE-COMP',
    5,
    'NM Car Accident Pure Comparative Negligence',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF NEW MEXICO CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
