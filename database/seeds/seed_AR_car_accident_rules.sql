...
-- Primary Authority: Ark. Code Ann. § 16-64-122
-- 
...
-- Source: Arkansas Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Arkansas Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Arkansas Legislature',
    'Ark. Code Ann. § 16-64-122',
    '',
    'statute',
    'high',
    'Arkansas follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: Ark. Code Ann. § 16-64-122. NEEDS REVIEW.'
...
-- Rule: Arkansas Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'AR-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'AR Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF ARKANSAS CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
