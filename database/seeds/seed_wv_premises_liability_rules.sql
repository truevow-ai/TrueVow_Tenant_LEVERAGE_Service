...
-- Primary Authority: West Virginia common law; Wheeling Park Comm''n v. Dattoli
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'West Virginia Premises Liability - Traditional Three-Tier Premises Liability',
    'West Virginia Courts',
    'West Virginia common law; Wheeling Park Comm''n v.',
    '',
    'case_law',
    'high',
    'West Virginia follows the Traditional Three-Tier Premises Liability for premises liability cases. Authority: West Virginia common law; Wheeling Park Comm''n v. Dattoli. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'WV-PREM-LIAB-TRAD-3-TIER',
    5,
    'WV Premises Liability Traditional Three-Tier Premises Liability',
    'content_check',
    'personal_injury',
    'premises_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "West Virginia common law; Wheeling Park Comm''n v. Dattoli",
...
-- =====================================================================================
-- END OF WEST VIRGINIA PREMISES LIABILITY SEED FILE
-- =====================================================================================
