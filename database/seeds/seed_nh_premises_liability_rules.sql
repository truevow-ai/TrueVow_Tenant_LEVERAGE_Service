...
-- Primary Authority: RSA § 212:34; Ouellette v. Blanchard
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'New Hampshire Premises Liability - Traditional Three-Tier Premises Liability',
    'New Hampshire Courts',
    'RSA § 212:34; Ouellette v. Blanchard',
    '',
    'case_law',
    'high',
    'New Hampshire follows the Traditional Three-Tier Premises Liability for premises liability cases. Authority: RSA § 212:34; Ouellette v. Blanchard. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'NH-PREM-LIAB-TRAD-3-TIER',
    5,
    'NH Premises Liability Traditional Three-Tier Premises Liability',
    'content_check',
    'personal_injury',
    'premises_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "RSA § 212:34; Ouellette v. Blanchard",
...
-- =====================================================================================
-- END OF NEW HAMPSHIRE PREMISES LIABILITY SEED FILE
-- =====================================================================================
