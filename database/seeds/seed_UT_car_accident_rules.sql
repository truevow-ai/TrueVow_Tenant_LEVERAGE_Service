...
-- Primary Authority: Utah Code Ann. § 78B-5-818
-- 
...
-- Source: Utah Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Utah Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Utah Legislature',
    'Utah Code Ann. § 78B-5-818',
    '',
    'statute',
    'high',
    'Utah follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: Utah Code Ann. § 78B-5-818. NEEDS REVIEW.'
...
-- Rule: Utah Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'UT-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'UT Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF UTAH CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
