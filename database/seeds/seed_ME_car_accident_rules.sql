...
-- Primary Authority: 14 M.R.S. § 156
-- 
...
-- Source: Maine Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Maine Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Maine Legislature',
    '14 M.R.S. § 156',
    '',
    'statute',
    'high',
    'Maine follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: 14 M.R.S. § 156. NEEDS REVIEW.'
...
-- Rule: Maine Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'ME-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'ME Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF MAINE CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
