...
-- Primary Authority: Gen. Stat. § 52-572h
-- 
...
-- Source: Connecticut Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Connecticut Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Connecticut Legislature',
    'Gen. Stat. § 52-572h',
    '',
    'statute',
    'high',
    'Connecticut follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: Gen. Stat. § 52-572h. NEEDS REVIEW.'
...
-- Rule: Connecticut Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'CT-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'CT Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF CONNECTICUT CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
