...
-- Primary Authority: RCW § 7.72.010; Ulmer v. Ford Motor Co.
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Washington Product Liability - Strict Liability (Restatement 402A)',
    'Washington Courts',
    'RCW § 7.72.010; Ulmer v. Ford Motor Co.',
    '',
    'case_law',
    'high',
    'Washington follows the Strict Liability (Restatement 402A) for product liability cases. Authority: RCW § 7.72.010; Ulmer v. Ford Motor Co.. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'WA-PROD-LIAB-STRICT-402A',
    5,
    'WA Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "RCW § 7.72.010; Ulmer v. Ford Motor Co.",
...
-- =====================================================================================
-- END OF WASHINGTON PRODUCT LIABILITY SEED FILE
-- =====================================================================================
