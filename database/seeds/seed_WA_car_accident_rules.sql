...
-- Primary Authority: RCW § 4.22.005
-- 
...
-- Source: Washington Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Washington Car Accident Negligence System - Pure Comparative Negligence',
    'Washington Legislature',
    'RCW § 4.22.005',
    '',
    'statute',
    'high',
    'Washington follows the Pure Comparative Negligence system for determining fault in car accident cases. Citation: RCW § 4.22.005. NEEDS REVIEW.'
...
-- Rule: Washington Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'WA-PI-CAR-ACCDT-PURE-COMP',
    5,
    'WA Car Accident Pure Comparative Negligence',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF WASHINGTON CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
