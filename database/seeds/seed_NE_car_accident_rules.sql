...
-- Primary Authority: Neb. Rev. Stat. § 25-21,185.09
-- 
...
-- Source: Nebraska Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Nebraska Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Nebraska Legislature',
    'Neb. Rev. Stat. § 25-21,185.09',
    '',
    'statute',
    'high',
    'Nebraska follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: Neb. Rev. Stat. § 25-21,185.09. NEEDS REVIEW.'
...
-- Rule: Nebraska Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'NE-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'NE Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF NEBRASKA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
