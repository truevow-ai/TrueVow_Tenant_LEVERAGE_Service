...
-- Primary Authority: ORS § 30.970; Schock v. Ringling Bros.
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Oregon Premises Liability - Traditional Three-Tier Premises Liability',
    'Oregon Courts',
    'ORS § 30.970; Schock v. Ringling Bros.',
    '',
    'case_law',
    'high',
    'Oregon follows the Traditional Three-Tier Premises Liability for premises liability cases. Authority: ORS § 30.970; Schock v. Ringling Bros.. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'OR-PREM-LIAB-TRAD-3-TIER',
    5,
    'OR Premises Liability Traditional Three-Tier Premises Liability',
    'content_check',
    'personal_injury',
    'premises_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "ORS § 30.970; Schock v. Ringling Bros.",
...
-- =====================================================================================
-- END OF OREGON PREMISES LIABILITY SEED FILE
-- =====================================================================================
