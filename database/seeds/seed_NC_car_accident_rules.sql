...
-- Primary Authority: North Carolina common law
-- 
...
-- Source: North Carolina Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'North Carolina Car Accident Negligence System - Contributory Negligence',
    'North Carolina Legislature',
    'North Carolina common law',
    '',
    'statute',
    'high',
    'North Carolina follows the Contributory Negligence system for determining fault in car accident cases. Citation: North Carolina common law. NEEDS REVIEW.'
...
-- Rule: North Carolina Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'NC-PI-CAR-ACCDT-CONTRIBUTORY',
    5,
    'NC Car Accident Contributory Negligence',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
    ...
    '{
        ...
        "statute": "North Carolina common law",
...
-- =====================================================================================
-- END OF NORTH CAROLINA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
