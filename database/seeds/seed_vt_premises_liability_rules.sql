...
-- Primary Authority: 12 V.S.A. § 5792; Libby v. Perry, 311 A.2d 527 (Vt. 1973)
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Vermont Premises Liability - Traditional Three-Tier Premises Liability',
    'Vermont Courts',
    '12 V.S.A. § 5792; Libby v. Perry, 311 A.2d 527 (Vt',
    '',
    'case_law',
    'high',
    'Vermont follows the Traditional Three-Tier Premises Liability for premises liability cases. Authority: 12 V.S.A. § 5792; Libby v. Perry, 311 A.2d 527 (Vt. 1973). NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'VT-PREM-LIAB-TRAD-3-TIER',
    5,
    'VT Premises Liability Traditional Three-Tier Premises Liability',
    'content_check',
    'personal_injury',
    'premises_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "12 V.S.A. § 5792; Libby v. Perry, 311 A.2d 527 (Vt. 1973)",
...
-- =====================================================================================
-- END OF VERMONT PREMISES LIABILITY SEED FILE
-- =====================================================================================
