...
-- Primary Authority: New Mexico common law; Gerber v. Reeves, 64 N.M. 372 (1959)
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'New Mexico Premises Liability - Traditional Three-Tier Premises Liability',
    'New Mexico Courts',
    'New Mexico common law; Gerber v. Reeves, 64 N.M. 3',
    '',
    'case_law',
    'high',
    'New Mexico follows the Traditional Three-Tier Premises Liability for premises liability cases. Authority: New Mexico common law; Gerber v. Reeves, 64 N.M. 372 (1959). NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'NM-PREM-LIAB-TRAD-3-TIER',
    5,
    'NM Premises Liability Traditional Three-Tier Premises Liability',
    'content_check',
    'personal_injury',
    'premises_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "New Mexico common law; Gerber v. Reeves, 64 N.M. 372 (1959)",
...
-- =====================================================================================
-- END OF NEW MEXICO PREMISES LIABILITY SEED FILE
-- =====================================================================================
