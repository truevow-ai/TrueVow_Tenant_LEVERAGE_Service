...
-- Primary Authority: Idaho Code § 6-1401; McDevitt v. Standard Oil Co.
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Idaho Product Liability - Strict Liability (Restatement 402A)',
    'Idaho Courts',
    'Idaho Code § 6-1401; McDevitt v. Standard Oil Co.',
    '',
    'case_law',
    'high',
    'Idaho follows the Strict Liability (Restatement 402A) for product liability cases. Authority: Idaho Code § 6-1401; McDevitt v. Standard Oil Co.. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'ID-PROD-LIAB-STRICT-402A',
    5,
    'ID Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "Idaho Code § 6-1401; McDevitt v. Standard Oil Co.",
...
-- =====================================================================================
-- END OF IDAHO PRODUCT LIABILITY SEED FILE
-- =====================================================================================
