...
-- Primary Authority: Minn. Stat. § 544.41; McCormack v. Hankscraft Co.
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Minnesota Product Liability - Strict Liability (Restatement 402A)',
    'Minnesota Courts',
    'Minn. Stat. § 544.41; McCormack v. Hankscraft Co.',
    '',
    'case_law',
    'high',
    'Minnesota follows the Strict Liability (Restatement 402A) for product liability cases. Authority: Minn. Stat. § 544.41; McCormack v. Hankscraft Co.. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'MN-PROD-LIAB-STRICT-402A',
    5,
    'MN Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "Minn. Stat. § 544.41; McCormack v. Hankscraft Co.",
...
-- =====================================================================================
-- END OF MINNESOTA PRODUCT LIABILITY SEED FILE
-- =====================================================================================
