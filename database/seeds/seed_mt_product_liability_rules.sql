...
-- Primary Authority: Montana common law; Smith v. Western Seed Prod. Corp.
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Montana Product Liability - Strict Liability (Restatement 402A)',
    'Montana Courts',
    'Montana common law; Smith v. Western Seed Prod. Co',
    '',
    'case_law',
    'high',
    'Montana follows the Strict Liability (Restatement 402A) for product liability cases. Authority: Montana common law; Smith v. Western Seed Prod. Corp.. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'MT-PROD-LIAB-STRICT-402A',
    5,
    'MT Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "Montana common law; Smith v. Western Seed Prod. Corp.",
...
-- =====================================================================================
-- END OF MONTANA PRODUCT LIABILITY SEED FILE
-- =====================================================================================
