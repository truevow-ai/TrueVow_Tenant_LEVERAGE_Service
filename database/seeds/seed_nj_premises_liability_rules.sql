...
-- Primary Authority: N.J.S.A. § 2A:42A-2; Hopkins v. Fox & Lazo Realtors
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'New Jersey Premises Liability - Traditional Three-Tier Premises Liability',
    'New Jersey Courts',
    'N.J.S.A. § 2A:42A-2; Hopkins v. Fox & Lazo Realtor',
    '',
    'case_law',
    'high',
    'New Jersey follows the Traditional Three-Tier Premises Liability for premises liability cases. Authority: N.J.S.A. § 2A:42A-2; Hopkins v. Fox & Lazo Realtors. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'NJ-PREM-LIAB-TRAD-3-TIER',
    5,
    'NJ Premises Liability Traditional Three-Tier Premises Liability',
    'content_check',
    'personal_injury',
    'premises_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "N.J.S.A. § 2A:42A-2; Hopkins v. Fox & Lazo Realtors",
...
-- =====================================================================================
-- END OF NEW JERSEY PREMISES LIABILITY SEED FILE
-- =====================================================================================
