...
-- Primary Authority: SDCL § 20-9-10; Huset v. J.I. Case Threshing Machine Co.
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'South Dakota Product Liability - Strict Liability (Restatement 402A)',
    'South Dakota Courts',
    'SDCL § 20-9-10; Huset v. J.I. Case Threshing Machi',
    '',
    'case_law',
    'high',
    'South Dakota follows the Strict Liability (Restatement 402A) for product liability cases. Authority: SDCL § 20-9-10; Huset v. J.I. Case Threshing Machine Co.. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'SD-PROD-LIAB-STRICT-402A',
    5,
    'SD Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "SDCL § 20-9-10; Huset v. J.I. Case Threshing Machine Co.",
...
-- =====================================================================================
-- END OF SOUTH DAKOTA PRODUCT LIABILITY SEED FILE
-- =====================================================================================
