...
-- Source: New Hampshire Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'New Hampshire Car Accident Negligence System - Modified Comparative Negligence (51% Bar Rule)',
    'New Hampshire Legislature',
    'RSA § 507:7-d',
    '',
    'statute',
    'high',
    'New Hampshire follows the Modified Comparative Negligence (51% Bar Rule) system for determining fault in car accident cases. Citation: RSA § 507:7-d. NEEDS REVIEW.'
...
-- Rule: New Hampshire Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'NH-PI-CAR-ACCDT-MOD-COMP-51',
    5,
    'NH Car Accident Modified Comparative Negligence (51% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF NEW HAMPSHIRE CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
