...
-- Primary Authority: O.C.G.A. § 51-12-33
-- 
...
-- Source: Georgia Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Georgia Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Georgia Legislature',
    'O.C.G.A. § 51-12-33',
    '',
    'statute',
    'high',
    'Georgia follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: O.C.G.A. § 51-12-33. NEEDS REVIEW.'
...
-- Rule: Georgia Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'GA-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'GA Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF GEORGIA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
