...
-- Source: Ohio Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Ohio Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Ohio Legislature',
    'ORC § 2315.33',
    '',
    'statute',
    'high',
    'Ohio follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: ORC § 2315.33. NEEDS REVIEW.'
...
-- Rule: Ohio Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'OH-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'OH Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF OHIO CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
