...
-- Primary Authority: N.Y. Gen. Bus. Law § 198-a; Codling v. Paglia, 32 N.Y.2d 330 (1973)
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'New York Product Liability - Strict Liability (Restatement 402A)',
    'New York Courts',
    'N.Y. Gen. Bus. Law § 198-a; Codling v. Paglia, 32 ',
    '',
    'case_law',
    'high',
    'New York follows the Strict Liability (Restatement 402A) for product liability cases. Authority: N.Y. Gen. Bus. Law § 198-a; Codling v. Paglia, 32 N.Y.2d 330 (1973). NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'NY-PROD-LIAB-STRICT-402A',
    5,
    'NY Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "N.Y. Gen. Bus. Law § 198-a; Codling v. Paglia, 32 N.Y.2d 330 (1973)",
...
-- =====================================================================================
-- END OF NEW YORK PRODUCT LIABILITY SEED FILE
-- =====================================================================================
