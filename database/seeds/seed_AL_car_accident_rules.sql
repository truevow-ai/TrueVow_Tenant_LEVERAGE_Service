...
-- Primary Authority: Alabama common law
-- 
...
-- Source: Alabama Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Alabama Car Accident Negligence System - Contributory Negligence',
    'Alabama Legislature',
    'Alabama common law',
    '',
    'statute',
    'high',
    'Alabama follows the Contributory Negligence system for determining fault in car accident cases. Citation: Alabama common law. NEEDS REVIEW.'
...
-- Rule: Alabama Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'AL-PI-CAR-ACCDT-CONTRIBUTORY',
    5,
    'AL Car Accident Contributory Negligence',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF ALABAMA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
