...
-- Primary Authority: N.D.C.C. § 32-03-21
-- 
...
-- Source: North Dakota Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'North Dakota Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'North Dakota Legislature',
    'N.D.C.C. § 32-03-21',
    '',
    'statute',
    'high',
    'North Dakota follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: N.D.C.C. § 32-03-21. NEEDS REVIEW.'
...
-- Rule: North Dakota Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'ND-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'ND Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF NORTH DAKOTA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
