...
-- Primary Authority: Nebraska common law; Harris v. Niehaus, 243 Neb. 208 (1993)
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Nebraska Premises Liability - Traditional Three-Tier Premises Liability',
    'Nebraska Courts',
    'Nebraska common law; Harris v. Niehaus, 243 Neb. 2',
    '',
    'case_law',
    'high',
    'Nebraska follows the Traditional Three-Tier Premises Liability for premises liability cases. Authority: Nebraska common law; Harris v. Niehaus, 243 Neb. 208 (1993). NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'NE-PREM-LIAB-TRAD-3-TIER',
    5,
    'NE Premises Liability Traditional Three-Tier Premises Liability',
    'content_check',
    'personal_injury',
    'premises_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "Nebraska common law; Harris v. Niehaus, 243 Neb. 208 (1993)",
...
-- =====================================================================================
-- END OF NEBRASKA PREMISES LIABILITY SEED FILE
-- =====================================================================================
