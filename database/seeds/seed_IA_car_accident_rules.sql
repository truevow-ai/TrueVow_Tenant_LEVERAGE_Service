...
-- Primary Authority: Iowa Code § 668.3(1)
-- 
...
-- Source: Iowa Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Iowa Car Accident Negligence System - Modified Comparative Negligence (50% Bar Rule)',
    'Iowa Legislature',
    'Iowa Code § 668.3(1)',
    '',
    'statute',
    'high',
    'Iowa follows the Modified Comparative Negligence (50% Bar Rule) system for determining fault in car accident cases. Citation: Iowa Code § 668.3(1). NEEDS REVIEW.'
...
-- Rule: Iowa Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'IA-PI-CAR-ACCDT-MOD-COMP-50',
    5,
    'IA Car Accident Modified Comparative Negligence (50% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF IOWA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
