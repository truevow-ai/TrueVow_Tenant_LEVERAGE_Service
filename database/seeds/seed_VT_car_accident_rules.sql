...
-- Primary Authority: 12 V.S.A. § 1079
-- 
...
-- Source: Vermont Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Vermont Car Accident Negligence System - Modified Comparative Negligence (51% Bar Rule)',
    'Vermont Legislature',
    '12 V.S.A. § 1079',
    '',
    'statute',
    'high',
    'Vermont follows the Modified Comparative Negligence (51% Bar Rule) system for determining fault in car accident cases. Citation: 12 V.S.A. § 1079. NEEDS REVIEW.'
...
-- Rule: Vermont Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'VT-PI-CAR-ACCDT-MOD-COMP-51',
    5,
    'VT Car Accident Modified Comparative Negligence (51% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF VERMONT CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
