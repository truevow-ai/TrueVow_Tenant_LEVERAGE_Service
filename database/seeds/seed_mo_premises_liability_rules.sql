...
-- Primary Authority: Missouri common law; Carter v. Kinney, 896 S.W.2d 926 (Mo. 1995)
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Missouri Premises Liability - Traditional Three-Tier Premises Liability',
    'Missouri Courts',
    'Missouri common law; Carter v. Kinney, 896 S.W.2d ',
    '',
    'case_law',
    'high',
    'Missouri follows the Traditional Three-Tier Premises Liability for premises liability cases. Authority: Missouri common law; Carter v. Kinney, 896 S.W.2d 926 (Mo. 1995). NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'MO-PREM-LIAB-TRAD-3-TIER',
    5,
    'MO Premises Liability Traditional Three-Tier Premises Liability',
    'content_check',
    'personal_injury',
    'premises_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "Missouri common law; Carter v. Kinney, 896 S.W.2d 926 (Mo. 1995)",
...
-- =====================================================================================
-- END OF MISSOURI PREMISES LIABILITY SEED FILE
-- =====================================================================================
