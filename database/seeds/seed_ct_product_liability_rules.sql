...
-- Primary Authority: Conn. Gen. Stat. § 52-572m; Potter v. Chicago Pneumatic Tool Co.
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Connecticut Product Liability - Strict Liability (Restatement 402A)',
    'Connecticut Courts',
    'Conn. Gen. Stat. § 52-572m; Potter v. Chicago Pneu',
    '',
    'case_law',
    'high',
    'Connecticut follows the Strict Liability (Restatement 402A) for product liability cases. Authority: Conn. Gen. Stat. § 52-572m; Potter v. Chicago Pneumatic Tool Co.. NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'CT-PROD-LIAB-STRICT-402A',
    5,
    'CT Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "Conn. Gen. Stat. § 52-572m; Potter v. Chicago Pneumatic Tool Co.",
...
-- =====================================================================================
-- END OF CONNECTICUT PRODUCT LIABILITY SEED FILE
-- =====================================================================================
