...
-- Primary Authority: Tex. Civ. Prac. & Rem. Code § 33.001
-- 
...
-- Source: Texas Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Texas Car Accident Negligence System - Modified Comparative Negligence (51% Bar Rule)',
    'Texas Legislature',
    'Tex. Civ. Prac. & Rem. Code § 33.001',
    '',
    'statute',
    'high',
    'Texas follows the Modified Comparative Negligence (51% Bar Rule) system for determining fault in car accident cases. Citation: Tex. Civ. Prac. & Rem. Code § 33.001. NEEDS REVIEW.'
...
-- Rule: Texas Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'TX-PI-CAR-ACCDT-MOD-COMP-51',
    5,
    'TX Car Accident Modified Comparative Negligence (51% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF TEXAS CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
