...
-- Primary Authority: Ind. Code § 34-51-2-6
-- 
...
-- Source: Indiana Negligence System for Auto Accidents
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Indiana Car Accident Negligence System - Modified Comparative Negligence (51% Bar Rule)',
    'Indiana Legislature',
    'Ind. Code § 34-51-2-6',
    '',
    'statute',
    'high',
    'Indiana follows the Modified Comparative Negligence (51% Bar Rule) system for determining fault in car accident cases. Citation: Ind. Code § 34-51-2-6. NEEDS REVIEW.'
...
-- Rule: Indiana Car Accident Negligence System
INSERT INTO leverage.validation_rules (
    ...
    'IN-PI-CAR-ACCDT-MOD-COMP-51',
    5,
    'IN Car Accident Modified Comparative Negligence (51% Bar Rule)',
    'content_check',
    'personal_injury',
    'car_accident',
    'complaint',
...
-- =====================================================================================
-- END OF INDIANA CAR ACCIDENT RULES SEED FILE
-- =====================================================================================
