...
-- Primary Authority: Fla. Stat. § 768.81; West v. Caterpillar Tractor Co., 336 So.2d 80 (Fla. 1976)
--
...
INSERT INTO leverage.legal_sources (
    ...
    NULL,
    NULL,
    'Florida Product Liability - Strict Liability (Restatement 402A)',
    'Florida Courts',
    'Fla. Stat. § 768.81; West v. Caterpillar Tractor C',
    '',
    'case_law',
    'high',
    'Florida follows the Strict Liability (Restatement 402A) for product liability cases. Authority: Fla. Stat. § 768.81; West v. Caterpillar Tractor Co., 336 So.2d 80 (Fla. 1976). NEEDS REVIEW - pending attorney verification.'
...
INSERT INTO leverage.validation_rules (
    ...
    'FL-PROD-LIAB-STRICT-402A',
    5,
    'FL Product Liability Strict Liability (Restatement 402A)',
    'content_check',
    'personal_injury',
    'product_liability',
    'complaint',
    ...
    '{
        ...
        "statute": "Fla. Stat. § 768.81; West v. Caterpillar Tractor Co., 336 So.2d 80 (Fla. 1976)",
...
-- =====================================================================================
-- END OF FLORIDA PRODUCT LIABILITY SEED FILE
-- =====================================================================================
